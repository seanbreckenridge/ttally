...
# accept args/kwargs to ignore additional arguments passed by load_prompt_and_writeback
def namedtuple_prompt_now(nt: Type[NamedTuple], *args: Any, **kwargs: Any) -> NamedTuple:
...
def prompt_now(nt: Type[NamedTuple]) -> None:
    ...
    load_prompt_and_writeback(nt, p, prompt_function=namedtuple_prompt_now)
